...
// Check whether [addr, addr+length) is contained in a direct ACL VMM
// allocation (allocated via ascend_allocate_vmm_memory_direct). Returns false
// for adxl::MallocMem allocations and non-VMM host buffers.
